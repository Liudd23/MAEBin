...
def build_args():
    ...
    parser.add_argument("--graphfile", type=str, required=True, help="path to the first input file")
    parser.add_argument("--embeddingfile", type=str, required=True, help="path to the second input file")
